...
跨世界 Roguelike 元进度模组（NeoForge 1.21.1）。
...
1. 安装 [NeoForge](https://neoforged.net/)（Minecraft 1.21.1）
2. 在 [Releases](https://github.com/anomalyco/Soulbound/releases) 下载最新 jar
3. 放入 `mods` 文件夹
